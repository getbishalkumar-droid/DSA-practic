...
//deleting alternet element
void delalt(node* head){
    node* curr=head;
    while(curr!=NULL&&curr->next!=NULL){//condition should written in this order
        node* temp=curr->next;
...
int main(){
    ...
    //deleting from alternet position
    delalt(head);
